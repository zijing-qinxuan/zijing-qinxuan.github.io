...
const englishPhrases = {
  ...
  '依現場引導入場': 'Follow the On-site Guidance', '抵達聚會所後，請依現場接待人員指引前往 2 樓。': 'After arriving at the Kingdom Hall, please follow our reception team’s directions to the second floor.',
  ...
  '交通與抵達': 'Directions & Arrival', '建議提前 20～30 分鐘抵達，預留停車、報到與入座時間。': 'We recommend arriving 20–30 minutes early to allow time for parking, check-in, and seating.',
